...
<div class="form-group mb-3">
    ...
    <textarea type="text" name="description" class="form-control @error('description') is-invalid @enderror" value="{{ old('description', $transaction?->description) }}" id="description" placeholder="Description">{{ old('description', $transaction?->description) }}</textarea>
